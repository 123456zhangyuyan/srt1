document.addEventListener("DOMContentLoaded", function() {
  ...
  window.kgData = {
nodes: {
      "孝经": { name: "孝经", type: "book",description: "《孝经》，记载了孔子向曾子讲述孝道的言论，是儒家十三经之一。"},
    ...
    links: [
     { source: "稷", target: "孝经", rela: "来源于", type: "literature" },
     { source: "牲", target: "孝经", rela: "来源于", type: "literature" },
     { source: "象", target: "孝经", rela: "来源于", type: "literature" }
    ]
  };
